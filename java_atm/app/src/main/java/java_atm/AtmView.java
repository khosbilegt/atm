...
public class AtmView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setMinimumSize(new java.awt.Dimension(25, 100));
        ...
        jLabel6.setText(" ");
        jLabel6.setMaximumSize(new java.awt.Dimension(1522, 1522));
    ...
    void addToField(int num) {
        String initialText = jTextField1.getText();
        jTextField1.setText(initialText + Integer.toString(num));
    }
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        if(initialText.length() > 0) {
            jTextField1.setText(initialText.substring(0, initialText.length() - 1));
        }
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        if(accountNumber.length() == 0) {
            if(value.length() == 9 && DataHandler.isFullyInteger(value)) {
                boolean valid = DatabaseHandler.isAccountValid(value);
                if(valid) {
                    accountNumber = value;
                    jLabel1.setText("PIN:");
                    jTextField1.setText("");
